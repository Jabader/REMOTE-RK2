...
#define DRIVER_NAME "rockchip-pwm2-j"
...
static const struct of_device_id rk_pwm_of_match[] = {
	{ .compatible =  "rockchip,remotectl-pwm2"},
	{ }
};
...
MODULE_AUTHOR("Firefly && Jabader");
MODULE_DESCRIPTION("Remotecontrol univers driver module");
